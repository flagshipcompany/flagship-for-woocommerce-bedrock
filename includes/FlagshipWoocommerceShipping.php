...
use FlagshipWoocommerce\Helpers\Order_Filter_Helper;
...
class FlagshipWoocommerceShipping {
	...
	public function hooks() {
			...
			if (is_admin()) {
				...
				$order_filter_helper = (new Order_Filter_Helper());
				add_action('restrict_manage_posts', array($order_filter_helper, 'filter_orders_by_coupon_used'));
				add_filter('posts_where', array($order_filter_helper, 'add_filterable_where'));
			}
	}
